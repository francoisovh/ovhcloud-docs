...
{/* DRAFT: À documenter — ajouter le chemin de navigation exact dans la console Google Cloud (Network Connectivity > Interconnect > VLAN attachments > Create), les sélections Cloud Router / région / capacité, le libellé exact de l'option d'activation automatique, et l'emplacement où s'affiche la clé d'appairage. */}
