...
:::info
Notre Marketplace vous donne accès à une douzaine d'actions sélectionnées pour démarrer rapidement vos Data Projects de traitement : actions *load*, actions *aggregate*, actions *delete*, etc. Si vous ne trouvez pas ce dont vous avez besoin dans le catalogue, vous pouvez toujours recourir à une action *custom* qui vous permet d'**exécuter n'importe quel morceau de code Python 3+** au sein de vos pipelines de données.
:::

[En savoir plus sur les actions Custom](/guides/public-cloud/data-platform/dpe-actions-custom).
...
[En savoir plus sur la configuration des preferences d'exécution.](/guides/public-cloud/data-platform/dpe-jobs-preferences)
