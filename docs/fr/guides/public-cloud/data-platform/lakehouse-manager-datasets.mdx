...
- **Buckets** : un espace de stockage d'objets compatible S3 pour les fichiers non structurés, indépendant du Lakehouse. Voir [Buckets](/guides/public-cloud/data-platform/lakehouse-manager-buckets).
