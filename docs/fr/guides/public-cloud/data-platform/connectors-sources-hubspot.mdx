...
## 4. Types d'endpoints disponibles
...
## 5. Ajouter une source HubSpot sur Data Platform

1. Dans les **Connectors** de la Data Platform, trouvez **HubSpot** dans le source store et cliquez sur **Select**.
2. Collez le token Private App de l'[étape 2](#2-obtenir-un-token-api) dans le champ **Clé API HubSpot**.
...
## 6. Exemple rapide : extraire les contacts
...
## 8. Limites selon le plan HubSpot
