...
:::info
Ne vous inquiétez pas pour la sauvegarde, le Formatter fonctionne en mode autosave.
:::
...
Vous avez presque terminé ! Encore une dernière étape ! Publions les changements récents du dashboard en production. Pour cela, n'oubliez pas de sauvegarder 💾 puis retournez à l'onglet **Overview** de l'Application Manager. Vous devez d'abord cliquer sur **Stop** pour arrêter l'application actuellement déployée. Dès qu'elle s'est arrêtée, cliquez sur **Build**, puis sur **Deploy**.
