...
:::info
Les event logs sont stockés dans le **bucket S3 DPE** de votre projet. Les règles de [Retention](#retention) ci-dessous contrôlent la part de ce stockage qu'ils utilisent.
:::
