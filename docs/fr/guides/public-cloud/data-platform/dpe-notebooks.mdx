...
Notebooks est une intégration native de [Jupyter Notebooks](https://jupyter.org/) sur Data Platform. Livrés avec des paquets préchargés pour la data science, ils vous permettent d'effectuer des analyses statistiques interactives et des visualisations de données en dehors du temps réel. Les notebooks sont fortement connectés au reste de votre Project, ce qui permet de lire/écrire des données dans le Lakehouse Manager grâce à [notre SDK](/guides/public-cloud/data-platform/landing-page-developers-python-sdk) ou de convertir le code de votre notebook en une action [Data Processing Engine](/guides/public-cloud/data-platform/landing-page-dpe).
...
:::info
Utilisez le SDK Data Platform pour interagir facilement avec le reste de votre Project, typiquement pour **importer/traiter/exporter des données** depuis et vers vos [tables du Lakehouse Manager](/guides/public-cloud/data-platform/lakehouse-manager-tables).
:::
