...
Elle est disponible pour les connecteurs PySpark compatibles de type stockage objet (actuellement Data Platform Buckets, S3 et [Azure Blob Storage](/guides/public-cloud/data-platform/connectors-sources-blob-storage))
