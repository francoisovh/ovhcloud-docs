...
- `scripts` : ce dossier contient des scripts utiles que vous pouvez utiliser pour générer des composants, des dashboards, ou pour zipper ce Project afin de le charger facilement sur la platform.
...
La première étape consiste à relier votre application locale au service d'authentification et à l'API créée précédemment sur votre Project.
...
Prêt à relever ce défi ? 🧗🏽‍♂️ Apprenons à créer et modifier des graphiques !
