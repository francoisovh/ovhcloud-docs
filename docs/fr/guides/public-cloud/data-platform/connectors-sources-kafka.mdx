...
Apache Kafka est un magasin d'événements distribué et une platform de traitement de flux développée par l'Apache Software Foundation. Grâce au connecteur Kafka, vous pouvez vous connecter à votre serveur Kafka et intégrer en temps réel les données que vous recevez sur le serveur à votre Project.
