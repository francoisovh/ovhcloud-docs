...
Ce mode de segmentation fonctionne de la même manière que la [segmentation basée sur un attribut d'une table de Project](/guides/public-cloud/data-platform/tutorials-segmentation-table-attribute#comment-cela-fonctionne-t-il-en-coulisses). La seule différence est que les valeurs sont déjà définies dans la configuration, plutôt qu'un attribut de table du Lakehouse Manager, il n'y a donc pas besoin de pré-stage.
