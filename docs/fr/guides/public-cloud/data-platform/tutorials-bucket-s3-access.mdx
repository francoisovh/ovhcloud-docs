---
title: Accéder à vos buckets avec des outils compatibles S3
...
:::info
Dans les URL de base des extraits de code ci-dessous, vous devrez remplacer `my-project` par le [sous-domaine de votre Project](/guides/public-cloud/data-platform/manage-projects-config-variables#sous-domaine-du-projet).
:::
...
```
1. Quelques exemples de commandes (en remplaçant `my-project` par le [sous-domaine de votre Project](/guides/public-cloud/data-platform/manage-projects-config-variables#sous-domaine-du-projet) et 'mybucket' par le nom de bucket souhaité) :
...
1. Configurez rclone (en remplaçant `my-project` par le [sous-domaine de votre Project](/guides/public-cloud/data-platform/manage-projects-config-variables#sous-domaine-du-projet)).
```bash
...
:::info
Dans les URL de base des extraits de code ci-dessous, vous devrez remplacer `[PROJECT_NAME]` par le [sous-domaine de votre Project](/guides/public-cloud/data-platform/manage-projects-config-variables#sous-domaine-du-projet).
:::
