...
Ne vous inquiétez pas s'il ne fonctionne pas encore, son comportement sera défini dans la section suivante.
...
Si vous vous êtes perdu 😪 en cours de route, pas d'inquiétude. Vous pouvez trouver le code final [ici](https://github.com/forepaas/getting-started/tree/release/advanced/src/components/DynamicParameterCheckbox).
...
Si vous vous êtes perdu, pas d'inquiétude. Vous pouvez trouver le code final [ici](https://github.com/forepaas/getting-started/tree/release/advanced/src/components/ChartMap).
...
Vous pouvez également utiliser notre script préconstruit pour zipper votre application ; pour générer un fichier zip prêt à être chargé sur votre Project, exécutez simplement cette commande.
