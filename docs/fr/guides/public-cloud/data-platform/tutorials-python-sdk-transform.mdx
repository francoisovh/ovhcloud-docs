...
Dans ce cas, nous vous conseillons de stocker et de manipuler les fichiers avec les [Buckets de la Data Platform](/guides/public-cloud/data-platform/lakehouse-manager-buckets) dans votre Project.
...
:::tip
Cela fonctionne aussi avec tout **Object Store** que vous pouvez définir comme **source compatible S3** dans les Connectors.
:::
