...
- **Corrections :**
  - Correction d'un problème où l'usage du Current Project affichait plusieurs supersets. Affiche désormais une seule colonne superset avec la consommation totale, de la même manière que pour les apps et API.
...
- Correction d'un problème où le connector Power BI renvoyait le mauvais sous-domaine lors du partage d'URL de Project.
...
- Le stockage compatible S3 met désormais automatiquement le champ region en minuscules pour la cohérence
