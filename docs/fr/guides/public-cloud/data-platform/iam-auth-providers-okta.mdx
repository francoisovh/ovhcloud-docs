...
Utilisez-vous [Okta](https://www.okta.com/) pour la gestion de votre identité et de vos utilisateurs, et souhaitez-vous l'utiliser pour vous connecter à vos applications Data Platform ? Suivez simplement ce guide pour démarrer en un rien de temps.
