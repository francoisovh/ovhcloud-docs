...
:::warning
Notez que la **permission Project Admin est la seule permission commune aux deux IAM**. Un utilisateur ayant la permission *Project Admin* dans l'IAM de l'organisation dispose de la permission *Admin* dans le ou les IAM de projet sous-jacents.
:::
...
[En savoir plus sur les Utilisateurs, Groupes et Rôles](/guides/public-cloud/data-platform/landing-page-iam-users)
