...
Après avoir créé le policy tag, vous pouvez le configurer en ajoutant d'autres valeurs (par exemple tech, product) ou en modifiant sa description dans la section `Tag Informations`. Les policy tags doivent être configurés avec soin, en fonction des besoins de sécurité des données.
